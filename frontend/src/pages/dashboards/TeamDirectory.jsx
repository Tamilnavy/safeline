...
const TeamDirectory = () => {
  ...
  const getRoleLabel = (role) => {
    switch (role) {
      case 'ROLE_1': return 'Role 1 (Basic Access)';
      case 'ROLE_2': return 'Role 2 (Extended Access)';
          ...
          <div className="bg-white w-full max-w-sm rounded-[28px] shadow-2xl border border-slate-200 overflow-hidden animate-in zoom-in-95 duration-200" onClick={e => e.stopPropagation()}>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4">
                ...
                <div>
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-0.5">System Access</p>
                  <p className="text-xs font-bold text-slate-600 uppercase tracking-wider">{getRoleLabel(selectedMember.accessRole)}</p>
                </div>
              </div>
            </div>
